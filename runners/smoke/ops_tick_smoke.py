...
def main() -> None:
    payload = {
        "profile": {"agent_id": "robot_smoke_ops", "role": "custom", "style": "balanced", "metadata": {"source": "ops_tick_smoke"}},
        "observe": {
            "agent_id": "robot_smoke_ops",
            "tick": 1,
            "state": {"hp": 91, "mp": 20, "x": 33400, "y": 32800, "map_id": 68, "can_teleport": False, "extras": {"level": 28, "robot_uid": 9901}},
        },
        "decide": {
            "agent_id": "robot_smoke_ops",
            "tick": 1,
